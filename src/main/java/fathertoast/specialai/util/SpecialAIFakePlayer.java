...
public class SpecialAIFakePlayer extends FakePlayer {
    ...
    public void updateFakePlayerState() {
        absMoveTo( wrappedEntity.getX(), wrappedEntity.getY(), wrappedEntity.getZ(),
                wrappedEntity.getYRot(), wrappedEntity.getXRot() );
    ...
    public void updateWrappedEntityState() {
        wrappedEntity.absMoveTo( getX(), getY(), getZ(), getYRot(), getXRot() );
    ...
    public boolean addEffect( MobEffectInstance effect, @Nullable Entity entity ) {
        if( wrappedEntity != null ) { return wrappedEntity.addEffect( effect, entity ); }
        return false;
    }
