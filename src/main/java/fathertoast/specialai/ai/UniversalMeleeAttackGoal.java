...
public class UniversalMeleeAttackGoal extends Goal {
    ...
    /** This goal's {@link OwnerType}, which determines movement strategy. */
     ...
     * when {@link UniversalMeleeAttackGoal#ownerType} is {@link OwnerType#PATHER}.
     */
    private Path path;
     ...
     *                 when passed into {@link UniversalMeleeAttackGoal#ownerTypeOf(Mob)}.
     */
     ...
     */
    public static OwnerType ownerTypeOf( Mob entity ) {
        // Squids require special handling
        if( entity instanceof Squid ) {
            return OwnerType.SQUID;
        }
        // So do bats
        if( entity instanceof Bat ) {
            return OwnerType.BAT;
        }
        ...
        if( entity instanceof FlyingMob && entity.getNavigation() instanceof GroundPathNavigation ) {
            return OwnerType.GENERIC_FLYING;
        }
        ...
        if( entity instanceof WaterAnimal && !(entity.getNavigation() instanceof WaterBoundPathNavigation) ) {
            return OwnerType.GENERIC_WATER;
        }
        ...
        if( entity.getNavigation() instanceof GroundPathNavigation
            ...
            return OwnerType.GENERIC_GROUND;
        }
        return OwnerType.PATHER;
    }
    ...
    public boolean canUse() {
        ...
        if( ownerType == OwnerType.PATHER && gameTime - lastCanUseCheck < CAN_USE_COOLDOWN ) {
            return false;
        }
        else {
            ...
            else if( ownerType == OwnerType.PATHER ) {
                if( canPenalize ) {
    ...
    public void tick() {
        ...
        if( target != null ) {
            ...
            ownerType.move( this, mob, target, distanceSqr );
    ...
    /**
     * Represents a type of goal owner.
     * <br><br>
    ...
    public enum OwnerType {
        ...
        OwnerType( Consumer<MoverContext> moveAction ) {
            this.moveAction = moveAction;
        }
        
        /** Calls this owner type's move action with the given parameters. */
    ...
    /** Context holder for {@link OwnerType} movement strategy handling. */
